...
def slope_field(t, x, diffeq, 
    ...
    ax.quiver(T, X, dtu, dxu,  # Plot a 2D field of arrows
               ...
               color = color,
               headwidth = 0,  # changeswizard: set arrowhead width to 0 to remove arrowheads
               headlength = 0,  # changeswizard: set arrowhead length to 0 to remove arrowheads
               headaxislength = 0,  # changeswizard: set arrowhead axis length to 0 to remove arrowheads
...
def plot_dt(t, x, diffeq, t0, x0, dt, nsteps, color = 'blue', ax=None, npts=100, clear=False):
    ...
    for i in range(0, nsteps):
        # changeswizard: added headwidth, headlength, headaxislength parameters to remove arrowheads
